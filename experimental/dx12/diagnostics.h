...
enum class Metric : uint32_t { Render, InputWait, FenceWait, Present, LatencyWait, Submit,
    Pipeline, Bindings, IndexScan, Upload, Allocate, Count };
...
void producer(uint64_t id, uint64_t ready, uint64_t returned, double interval_ms, uint32_t vertices) noexcept;
