...
if(-not $SkipGpuTests){$taskTargets+=@('dx12_device_test','dx12_render_test','dx12_glide_test','dx12_menu_test','dx12_diagnostics_test','dx12_upload_cache_test')}
...
if(-not $SkipGpuTests){$taskTests+=@('dx12_device_test','dx12_render_test','dx12_glide_test','dx12_menu_test','dx12_diagnostics_test','dx12_upload_cache_test')}
foreach($taskTest in $taskTests){
    if($taskTest -in @('dx12_diagnostics_test','dx12_upload_cache_test')){
