...
**Median XL players:** use the [simple installation guide and latest download](../README.md). The upstream description below is retained for reference; the fork's supported version and checks are listed in the player guide.
