...
1. Open the Median XL launcher and let it finish updating. Choose **Glide or DirectDraw**, turn on **Unofficial Graphics Drivers** for that choice, and turn **Windowed** off.
