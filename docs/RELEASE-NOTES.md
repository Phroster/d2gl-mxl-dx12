# MXL Smooth Motion DX12 1.12

**Improved performance, smoother movement and loot that stands out.**

[Download 1.12](https://github.com/Phroster/d2gl-mxl-dx12/releases/download/v1.12/mxl-smooth-motion-dx12-1.12.zip)
...
- Readable loot names stay visible; click the name or effect to pick it up without Alt.
- Easy pickup with your inventory open.
- Faster game entry with loot effects ready to go.
...
**Already installed?** Replace `glide3x.dll`, `ddraw.dll` and `mxl-diagnostics.ini`, and add `mxl-native-loot.ini`. Keep your existing `d2gl.ini`, `d2fps.ini` and matching `d2gl.mpq` to preserve your settings. **Keep the game's existing `d2fps.dll`; it is required.**

If Alt switches the old loot labels on, clear **Show Items** in the game's key bindings. Keep **HD text** enabled for the new labels. [Loot and pickup guide](https://github.com/Phroster/d2gl-mxl-dx12/blob/v1.12/docs/loot-effects-guide.md).
...
[Source for 1.12](https://github.com/Phroster/d2gl-mxl-dx12/tree/v1.12) · [Source download](https://github.com/Phroster/d2gl-mxl-dx12/archive/refs/tags/v1.12.zip) · [Licensing and credits](https://github.com/Phroster/d2gl-mxl-dx12/blob/v1.12/docs/LICENSING.md)
